        ...
        <>
            <Paper elevation={2} sx={{ p: 2 }}>
                    ...
                    <Table size="small" aria-label="a dense table">
                        <TableHead style={{ background: "#1976D2" }}>
                            <TableRow>
                                ...
                                <TableCell style={{ color: "#FFFFFF" }} align="left">Hours</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {post?.officehours?.map((singleday) => (
                                ...
                                >
                                    ...
                                    <TableCell data-testid="view-name" align="left">{singleday?.time}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
                ...
                <Grid container spacing={2}>
                    {
                        post?.locations?.servicecenter?.map(location => <LocationCard key={location.name} location={location} />)
                    }
                </Grid>
                <h2>ATM Locations</h2>
                <Grid container spacing={2}>
                    {
                        post?.locations?.atm?.map(location => <LocationCard key={location.name} location={location} />)
                    }
                </Grid>
            </Paper>
        </>
